...
async function main() {
  ...
  try {
    ...
    // 2. Obtener y actualizar conductor
    console.log('\n2. Obteniendo y actualizando conductor...');
    ...
    for (const c of conductores) {
      ...
      if (c.email === 'conductor1@allride.com') {
        ...
        // Actualizar el nombre a CONDU01
        console.log('   Actualizando nombre a CONDU01...');
        // Nota: No hay endpoint para actualizar usuario, pero el conductor ya existe
        console.log('   ✅ Conductor CONDU01 listo!');
      }
    }
