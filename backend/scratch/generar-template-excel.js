...
function generateTemplate() {
  ...
  const rutasData = [
    {
      ...
      'parada_4_nombre': 'Periférico Norte',
      'parada_4_latitud': 20.7102,
      'parada_4_longitud': -103.3950,
      'parada_5_nombre': 'Industrial Norte',
      'parada_5_latitud': 20.7250,
      'parada_5_longitud': -103.3800,
      'parada_6_nombre': 'Flex Norte, Tlaquepaque',
      'parada_6_latitud': 20.7350,
      'parada_6_longitud': -103.3650,
    }
  ];

  // 2. Hoja de Empleados/Pasajeros
  const empleadosData = [
    {
  ...
  const wsInstrucciones = XLSX.utils.json_to_sheet(instruccionesData, { header: 1 });
